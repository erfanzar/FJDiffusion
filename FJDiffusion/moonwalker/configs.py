...
class AutoencoderKlConfig(PretrainedConfig):
    ...
    def get_partition_rules(fully_fsdp: bool = True):
        return (("query/kernel", PartitionSpec("fsdp")),
                ...
                ("conv_out/kernel", PartitionSpec('ddp', "fsdp",)),
                ("key/bias", PartitionSpec('ddp', "fsdp",)),
                ("c1/kernel", PartitionSpec('ddp', "fsdp",)),
                ("quant_conv/kernel", PartitionSpec("fsdp")),
                ("conv_out/bias", PartitionSpec('ddp', "fsdp",)),
                ("group_norm/bias", PartitionSpec('ddp', "fsdp",)),
                ("query/bias", PartitionSpec('ddp', "fsdp",)),
                ("conv_in/bias", PartitionSpec('ddp', "fsdp",)),
                ("c2/bias", PartitionSpec('ddp', "fsdp",)),
                ("norm1/scale", PartitionSpec("fsdp")),
                ("proj_attn/bias", PartitionSpec('ddp', "fsdp",)),
