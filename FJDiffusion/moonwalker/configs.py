...
class AutoencoderKlConfig(PretrainedConfig):
    ...
    def get_partition_rules(fully_fsdp: bool = True):
        return (("query/kernel", PartitionSpec("fsdp")),
                ...
                ("conv_out/kernel", PartitionSpec('mp', None, "fsdp")),
                ("key/bias", PartitionSpec('mp', None, "fsdp")),
                ("c1/kernel", PartitionSpec('mp', None, "fsdp")),
                ("quant_conv/kernel", PartitionSpec("fsdp")),
                ("conv_out/bias", PartitionSpec('mp', None, "fsdp")),
                ("group_norm/bias", PartitionSpec("fsdp")),
                ("query/bias", PartitionSpec('mp', None, "fsdp")),
                ("conv_in/bias", PartitionSpec('mp', None, "fsdp")),
                ("c2/bias", PartitionSpec('mp', None, "fsdp")),
                ("norm1/scale", PartitionSpec("fsdp")),
                ("proj_attn/bias", PartitionSpec('mp', None, "fsdp")),
