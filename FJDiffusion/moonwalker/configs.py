...
class Unet2DConfig(PretrainedConfig):
    ...
    def get_partition_rules():
        return (
            ...
            ("conv_out/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("proj/(kernel|bias)", PartitionSpec("fsdp")),
            ("c2/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("l2/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("proj_in/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("cs/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("c1/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("net_2/(scale|bias)", PartitionSpec("fsdp")),
            ("norm2/(scale|bias)", PartitionSpec("fsdp")),
            ("conv_in/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ("norm1/(scale|bias)", PartitionSpec("fsdp")),
            ("norm3/(scale|bias)", PartitionSpec("fsdp")),
            ("l1/(kernel|bias)", PartitionSpec("fsdp")),
            ("conv/(kernel|bias)", PartitionSpec("dp", None, "fsdp")),
            ('.*', PartitionSpec(None))
        )
